...
public class notification_list_adpater extends BaseAdapter{
	Context context;
	...
	notification_list_adpater(Context context,
...
options = new DisplayImageOptions.Builder().cacheInMemory(true)
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		View itemView = inflater.inflate(R.layout.singlenotification, parent, false);
		...
		fname.setText(result.get("pm_name"));
		fdepart.setText(result.get("nm_date"));
		fqualifi.setText(result.get("nm_time"));
		
		fdesignation.setText(result.get("nm_desc"));
