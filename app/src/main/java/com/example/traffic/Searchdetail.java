...
public class Searchdetail extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnCreate.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i1 = new Intent(Searchdetail.this, CameraTestActivity.class);
				startActivity(i1);
			}
		});
		...
		Searchdetail.this).defaultDisplayImageOptions(defaultOptions)
	...
	class getproduct extends AsyncTask<Void, Void, Void>{
		...
		protected void onPreExecute() {
			...
			pd = new ProgressDialog(Searchdetail.this);
